...
def generate_timing_testbench(tc, test_id, netlist='Neuron.sp', vdd=0.9):
    ...
    w0_0_start = vdd if w0_0_end == 0 else 0
    w0_1_start = vdd if w0_1_end == 0 else 0
    w1_0_start = vdd if w1_0_end == 0 else 0
    w1_1_start = vdd if w1_1_end == 0 else 0
    w2_0_start = vdd if w2_0_end == 0 else 0
    w2_1_start = vdd if w2_1_end == 0 else 0
...
vx0_0 x_0<0> 0 PULSE({x0_0_start} {x0_0_end} 5n 25p 25p 500n 1000n)
vx0_1 x_0<1> 0 PULSE({x0_1_start} {x0_1_end} 5n 25p 25p 500n 1000n)
vx1_0 x_1<0> 0 PULSE({x1_0_start} {x1_0_end} 5n 25p 25p 500n 1000n)
vx1_1 x_1<1> 0 PULSE({x1_1_start} {x1_1_end} 5n 25p 25p 500n 1000n)
...
meas_names = ['t_input', 't_out0', 't_out1', 't_out2', 'tpd_0', 'tpd_1', 'tpd_2', 'v_z0_0_final', 'v_z0_1_final', 'v_z0_2_final', 'power_avg', 'temper']
